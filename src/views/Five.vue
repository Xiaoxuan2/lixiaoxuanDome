...
<el-button type="text" @click="dialogTableVisible = true">全部类别<i class="el-icon-arrow-down el-icon--right"></i></el-button>
...
<el-dialog title="收货地址" :visible.sync="dialogTableVisible">
  ...
  <el-dropdown-menu slot="dropdown">
    <el-dropdown-item>导入商品基础信息</el-dropdown-item>
    <el-dropdown-item>导入商品商城信息</el-dropdown-item>
    <el-dropdown-item>导入商品图片</el-dropdown-item>
...
<el-dialog title="商品类别-新增/编辑" :visible.sync="dialogFormVisible">
  ...
  <div slot="footer" class="dialog-footer">
    ...
    style="width: 77.2%;padding: 0px 0px"
